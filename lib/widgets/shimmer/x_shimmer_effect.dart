...
///
/// [XShimmerEffect] wraps a child widget and applies a moving linear gradient animation,
...
/// )
/// ```
class XShimmerEffect extends StatefulWidget {
  ...
  @override
  State<XShimmerEffect> createState() => _XShimmerEffectState();
}

class _XShimmerEffectState extends State<XShimmerEffect>
